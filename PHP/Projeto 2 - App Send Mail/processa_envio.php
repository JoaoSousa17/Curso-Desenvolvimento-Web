<?php
    ...
    try {
        ...
        $mail->Username   = 'jpsousa.2004@gmail.com';                  //SMTP username
        $mail->Password   = 'eqcyseajrrvqlqzm';                   //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;          //Enable implicit TLS encryption
        $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

        //Recipients
        $mail->setFrom('jpsousa.2004@gmail.com', 'João Sousa');
        ...
        $mensagem->status['desc_status'] = "Não foi possível enviar este email! Por favor tente novamente mais tarde. Detalhes do erro: {$mail->ErrorInfo}";
    }
?>
